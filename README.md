...
- `create_damage_report` verlangt Kategorie, konkrete Beschreibung, Dringlichkeit sowie Straße/Hausnummer, PLZ und Ort des betroffenen Objekts und darf erst nach ausdrücklicher Bestätigung aufgerufen werden.
